...
namespace CourseLibrary.API.Services
{
    public class CourseLibraryRepository : ICourseLibraryRepository, IDisposable
    {
        ...
        public IEnumerable<Author> GetAuthors(AuthorsResourceParamters authorsResourceParamters)
        {
            if (authorsResourceParamters == null)
            {
                return GetAuthors();
            }
            var mainCategory = authorsResourceParamters.MainCategory;
            var searchQuery = authorsResourceParamters.SearchQuery;
